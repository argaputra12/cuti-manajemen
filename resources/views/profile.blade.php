...
<div class="global-profile-container">
    ...
    <div class="pop-up-container-photo" id="photo">
      ...
      <button type="button" id="yes-button" onclick="closePopupPhoto()"><i class="fa-solid fa-check"></i>Save</button>
      <button type="button" id="cancel-button" onclick="closePopupPhoto()"><i class="fa-solid fa-xmark"></i>Cancel</button>
    </div>
